/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0cff2b0d5b55d532f421c58c4065297c)
// Runtime types generated with workerd@1.20251008.0 2026-01-22 
declare namespace Cloudflare {
	interface Env {
		...
		E2E_PRACTICE_ID: string;
		E2E_PRACTICE_SLUG: string;
		E2E_OWNER_EMAIL: string;
		E2E_OWNER_PASSWORD: string;
		E2E_CLIENT_EMAIL: string;
		E2E_CLIENT_PASSWORD: string;
		E2E_BACKEND_API_URL: string;
		E2E_WORKER_URL: string;
		E2E_BASE_URL: string;
		E2E_PAYMENT_MODE: string;
	}
}
...
type AiTextGenerationOutput = {
    response?: string;
    tool_calls?: Array<AiTextGenerationToolLegacyOutput | AiTextGenerationToolOutput>;
    usage?: UsageTags;
};
