...
PR series: #644 (foundation, merged) → #645 (Commit 4 + 5a + 5b, merged) → #646 (5c.1–5c.4, merged) → #647 (5d.1–5d.3, merged) → #648 (5d.4a + 5d.4b, merged) → #649 (5d.5, merged) → #650 (5e.2/3/4, merged) → #651 (5e.5 + 5e.1 + 5e.7, merged) → **#652 (this PR — 6a + 6b chat-pattern scaffolding).** Remaining: Commit 6c refactor (deferred — see note above; lands with consuming screen builds), Commit 7 (data display), Commit 8 (feature sweep).
