...
- **[Frontend API Implementation](./engineering/2025-11-29-FRONTEND_API_IMPLEMENTATION.md)** - Frontend API client setup and usage

## Documentation Index

- **Architecture**
  - [Organization Architecture (Archived)](./archive/organization/organization-architecture.md) ⚠️ Archived - Organization management migrated to remote API
  - [Stripe Architecture (Archived)](./archive/stripe/stripe-architecture.md) ⚠️ Archived - Stripe now handled by remote API
