  ...
  return (
    <div className="flex items-center gap-4 w-full flex-1 p-0 m-0 bg-none border-none h-8 animate-fade-in" role="dialog" aria-modal="true" aria-label="Audio recording in progress">
      <Button 
        ...
        className="flex items-center justify-center w-8 h-8 p-1.5 border-none rounded-full cursor-pointer transition-all duration-200 text-input-placeholder hover:text-[rgb(var(--error-foreground))] bg-white/5 hover:bg-[rgb(var(--error-foreground))]/10 animate-zoom-in"
      >
