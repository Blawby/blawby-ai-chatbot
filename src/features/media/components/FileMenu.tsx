  ...
  <div className="relative" ref={menuRef}>
   ...
   {errorMessage && (
    <div
     ...
     className="absolute bottom-full left-0 mb-2 min-w-[250px] p-3 glass-card border-[rgb(var(--error-foreground))]/30 bg-[rgb(var(--error-foreground))]/10"
     style={{ zIndex: THEME.zIndex.fileMenu + 1 }}
    >
     <div className="flex items-start gap-2">
      <div className="flex-1 text-sm text-[rgb(var(--error-foreground))]">{errorMessage}</div>
      <button
       onClick={() => setErrorMessage(null)}
       className="p-1 text-[rgb(var(--error-foreground))] hover:text-[rgb(var(--error-foreground))] dark:text-[rgb(var(--error-foreground))] dark:hover:text-[rgb(var(--error-foreground))] transition-colors"
