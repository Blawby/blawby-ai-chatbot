  ...
  return (
    ...
    >
      <DialogBody className="!overflow-visible space-y-4">
        ...
        />
        {error ? (
          <div className="flex items-center justify-between gap-3 rounded-r-md border border-neg/20 bg-neg/10 px-3 py-2 text-sm text-neg">
        ...
        {!isLoading && options.length === 0 && !error ? (
          <div className="flex items-center justify-between gap-3 rounded-r-md border border-rule bg-paper-2/50 px-3 py-3 text-sm text-dim-2">
        ...
        {destination ? (
          ...
          <p className="rounded-r-md border border-rule bg-paper-2/50 px-3 py-4 text-sm text-dim-2">
