    ...
    <div className="flex bg-dark-card-bg rounded-lg p-1" role="tablist" aria-label="Pricing tabs">
      <button
        ...
        className={`btn btn-tab px-4 py-2 rounded-md text-sm font-medium transition-colors ${
          selected === 'personal' ? 'active bg-surface-base text-input-text' : 'text-input-placeholder hover:text-input-text'
        }`}
      >
        {personalLabel}
      </button>
      <button
        ...
        className={`btn btn-tab px-4 py-2 rounded-md text-sm font-medium transition-colors ${
          selected === 'business' ? 'active bg-surface-base text-input-text' : 'text-input-placeholder hover:text-input-text'
        }`}
      >
        {businessLabel}
      </button>
