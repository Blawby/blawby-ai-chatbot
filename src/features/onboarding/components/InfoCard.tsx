...
export const InfoCard = ({
  ...
  const variantClasses = {
    ...
    blue: 'border-blue-500/30 bg-blue-500/10 text-blue-100 backdrop-blur-md',
    amber: 'border-amber-500/30 bg-amber-500/10 text-amber-100 backdrop-blur-md',
    green: 'border-emerald-500/30 bg-emerald-500/10 text-emerald-100 backdrop-blur-md',
    red: 'border-red-500/30 bg-red-500/10 text-red-100 backdrop-blur-md'
  };
