...
export const OnboardingContainer = ({
  ...
  return (
    <div className={cn('min-h-screen bg-light-bg dark:bg-dark-bg py-12 sm:px-6 lg:px-8 flex flex-col', className)}>
      ...
      {footer && (
        <div className={cn('w-full border-t border-gray-200 dark:border-white/10 bg-white dark:bg-dark-card-bg', footerSticky ? 'sticky bottom-0 z-20' : '')}>
          <div className="sm:mx-auto sm:w-full sm:max-w-2xl px-5 sm:px-10 py-4">
            {footer}
          </div>
        </div>
      )}
