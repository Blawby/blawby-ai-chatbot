...
const STATUS_COLOR: Record<MatterStatus, string> = {
  ...
  conflicted: 'bg-red-500 text-input-text ring-red-500/45',
  ...
  declined: 'bg-red-500 text-input-text ring-red-500/45',
  ...
  trial: 'bg-red-500 text-input-text ring-red-500/45',
