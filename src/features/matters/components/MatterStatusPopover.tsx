...
const STATUS_COLOR: Record<MatterStatus, string> = {
 ...
 conflicted: 'bg-surface-base0 text-input-text ring-red-500/45',
 ...
 declined: 'bg-surface-base0 text-input-text ring-red-500/45',
 intake_accepted: 'bg-blue-500 text-input-text ring-blue-500/45',
 engagement_draft: 'bg-amber-500 text-slate-950 ring-amber-500/45',
 engagement_sent: 'bg-violet-500 text-input-text ring-violet-500/45',
 engagement_accepted: 'bg-emerald-500 text-input-text ring-emerald-500/45',
 engagement_pending: 'bg-amber-500 text-slate-950 ring-amber-500/45',
 active: 'bg-emerald-500 text-input-text ring-emerald-500/45',
 ...
 trial: 'bg-surface-base0 text-input-text ring-red-500/45',
 order_entered: 'bg-emerald-500 text-input-text ring-emerald-500/45',
