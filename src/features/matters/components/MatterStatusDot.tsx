...
const STATUS_DOT_STYLES: Record<MatterStatus, string> = {
  ...
  intake_pending: 'text-amber-600 dark:text-amber-400',
  conflict_check: 'text-sky-600 dark:text-sky-400',
  conflicted: 'text-rose-600 dark:text-rose-400',
  eligibility: 'text-amber-600 dark:text-amber-400',
  ...
  pleadings_filed: 'text-sky-600 dark:text-sky-400',
  discovery: 'text-sky-600 dark:text-sky-400',
  mediation: 'text-sky-600 dark:text-sky-400',
  pre_trial: 'text-sky-600 dark:text-sky-400',
  trial: 'text-sky-600 dark:text-sky-400',
  order_entered: 'text-sky-600 dark:text-sky-400',
  appeal_pending: 'text-sky-600 dark:text-sky-400',
