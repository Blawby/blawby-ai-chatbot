  ...
  return (
    <div className={className}>
      <SettingSection
        first
        title="Support"
        description="Get product help, documentation, and the resources you need when something feels off."
      >
        <SettingsCard className="max-w-[760px]">
          ...
          {showReportBug && (
            ...
            >
              <Button onClick={handleReportBug} variant="ghost" size="sm">
          ...
          {showShortcuts && (
            ...
            >
              <Button onClick={handleKeyboardShortcuts} variant="ghost" size="sm">
      ...
      <SettingSection
        title="Policies"
        description="The legal and account terms that govern your workspace and product usage."
      >
        <SettingsCard className="max-w-[760px]">
          <SettingRow
