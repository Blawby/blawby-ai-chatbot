    ...
    <AccordionContent>
     <div className="flex flex-col gap-2">
      <a
       ...
       className="flex items-center gap-2 text-xs sm:text-sm text-input-placeholder dark:text-input-placeholder hover:text-accent dark:hover:text-accent transition-colors duration-200"
      >
