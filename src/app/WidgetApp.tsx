...
export const WidgetApp: FunctionComponent<WidgetAppProps> = ({
 ...
 const closeButton = useMemo(() => (
  <Button
   ...
   className="text-input-text/60 hover:text-input-text bg-surface-workspace/40 dark:bg-surface-utility/40 hover:bg-surface-workspace/60 dark:hover:bg-surface-utility/60 backdrop-blur-md border border-line-glass/20 shadow-lg"
  >
