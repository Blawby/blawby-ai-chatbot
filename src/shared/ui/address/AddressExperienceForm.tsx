          ...
          <div className="flex justify-end gap-3 pt-4">
            {onCancel && (
              <button
                ...
                onClick={onCancel}
                disabled={disabled}
                className="px-4 py-2 text-sm font-medium text-input-text rounded-md glass-input hover:bg-surface-glass/50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {cancelLabel}
              </button>
            )}
