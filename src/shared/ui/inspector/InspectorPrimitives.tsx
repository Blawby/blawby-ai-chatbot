    ...
    <div className="mt-6 flex items-center justify-center gap-3">
     {phone && (
      <button
        ...
        className="flex h-10 w-10 items-center justify-center rounded-full bg-accent-500/10 text-accent-600 transition hover:bg-accent-500/20 hover:text-accent-700 "
      >
