...
export const InspectorHeaderHero = ({
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-indigo-500/10 via-purple-500/5 to-transparent">
      ...
      <div className="relative flex flex-col items-center px-5 pb-8 pt-10 text-center">
        ...
        <div className="mt-6 min-w-0 max-w-full">
          ...
          {subtitle ? (
            <p className="mt-2 text-[13px] leading-relaxed text-white/70 line-clamp-3 px-2">{subtitle}</p>
          ) : null}
        </div>
