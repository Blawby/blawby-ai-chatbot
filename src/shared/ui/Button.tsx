...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(function Button({
  ...
  const baseClasses = 'inline-flex items-center justify-center rounded-full font-medium transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed border transition-shadow';
