...
export const TagInput = forwardRef<HTMLInputElement, TagInputProps>(({
 ...
 const variantClasses = {
  ...
  error: 'border-[rgb(var(--error-foreground))] dark:border-[rgb(var(--error-foreground))] focus-within:ring-red-500 focus-within:border-[rgb(var(--error-foreground))]',
  success: 'border-green-500 focus-within:ring-green-500 focus-within:border-green-400'
 };
      ...
      {filteredSuggestions.map((suggestion, index) => (
       <button
        ...
        className={cn(
         ...
         focusedSuggestionIndex === index && 'bg-accent-50 '
        )}
       >
        {suggestion}
       </button>
