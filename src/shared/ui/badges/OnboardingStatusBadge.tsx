...
export const OnboardingStatusBadge = ({ 
 ...
 const statusClasses = {
  completed: 'text-input-placeholder dark:text-input-placeholder bg-gray-100 dark:bg-surface-base border border-gray-300 ',
  pending: 'text-[rgb(var(--warning-foreground))] dark:text-[rgb(var(--warning-foreground))] bg-transparent border border-amber-300 hover:bg-amber-50 dark:hover:bg-amber-900/20',
  incomplete: 'text-[rgb(var(--error-foreground))] dark:text-[rgb(var(--error-foreground))] bg-transparent border border-[rgb(var(--error-foreground))] hover:bg-surface-base dark:hover:bg-red-900/20'
 };
