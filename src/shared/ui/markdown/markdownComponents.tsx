...
const CopyButton = ({ text }: { text: string }) => {
  ...
  return (
    <button
      type="button"
      onClick={handleCopy}
      className="absolute top-2 right-2 inline-flex items-center gap-1 rounded-md border border-[rgb(var(--surface-utility))]/10 bg-[rgb(var(--surface-app-frame))]/60 px-2 py-1 text-[11px] font-medium opacity-0 text-ink transition focus-visible:opacity-100 group-hover:opacity-100"
