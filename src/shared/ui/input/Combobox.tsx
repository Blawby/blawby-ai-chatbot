    ...
    <span
      className={cn(
        ...
        isCustom
          ...
          : 'border-line-glass/10 bg-surface-utility/40 text-input-text transition-colors'
      )}
    >
    ...
    <div ref={containerRef} className={cn('relative w-full', className, disabled && 'opacity-50 pointer-events-none')}>
      ...
      {isOpen && (
        <div
          ...
          onMouseDown={(e) => e.preventDefault()}
          className={cn(
            'z-50 w-full overflow-hidden rounded-xl bg-surface-workspace border border-line-glass/10 shadow-glass absolute',
        ...
        >
          ...
          <div className="max-h-60 overflow-y-auto py-1">
            ...
            {showAddRow && filteredOptions.length > 0 && (
              <div className="my-1 border-t border-line-glass/10" />
            )}
