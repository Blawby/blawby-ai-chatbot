     ...
     <div className="min-h-[220px] px-4 py-3">
      {value.trim().length > 0 ? (
       <div className="chat-markdown">
        {markdownError ? (
         <div className="mt-2 rounded border border-[rgb(var(--error-foreground))] bg-surface-base p-3 text-sm text-[rgb(var(--error-foreground))]  dark:text-[rgb(var(--error-foreground))]">
          <div className="mb-2">Failed to load markdown preview: {markdownError}</div>
          <button
           type="button"
           onClick={retryMarkdown}
           className="rounded bg-[rgb(var(--error-foreground))] px-2 py-1 text-xs font-medium text-input-text hover:bg-red-700 dark:hover:bg-[rgb(var(--error-foreground))]"
          >
           Retry
          </button>
         </div>
         ...
         <div className="mt-2 flex justify-center rounded border border-gray-200 bg-surface-base p-2 dark:bg-surface-base/40">
